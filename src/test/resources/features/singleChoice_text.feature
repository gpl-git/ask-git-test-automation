...
#          verify user role = TEACHER
  ...
  @smoke
  Scenario: Create a Quiz - Single Choice Question with Text Options
...
#      fill out question and option fields
    And I type "What is it?" into element with xpath "//mat-panel-title[contains(text(),'Q1')]/../../..//*[@formcontrolname='question']"
    When I type "Text1" into element with xpath "//mat-panel-title[contains(text(),'Q1')]/../../..//*[@placeholder='Option 1*']"
    When I type "Text2" into element with xpath "//mat-panel-title[contains(text(),'Q1')]/../../..//*[@placeholder='Option 2*']"
